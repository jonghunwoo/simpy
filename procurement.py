...
print("average working time of Process1_1: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_2.working_time/Proc1_2.subprocess_num)
print("average working time of Process1_2: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_3.working_time/Proc1_3.subprocess_num)
print("average working time of Process1_3: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_4.working_time/Proc1_4.subprocess_num)
print("average working time of Process1_4: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_5.working_time/Proc1_5.subprocess_num)
print("average working time of Process1_5: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_6.working_time/Proc1_6.subprocess_num)
print("average working time of Process1_6: {:2.2f}".format(working_time_1[-1]))
working_time_1.append(Proc1_7.working_time/Proc1_7.subprocess_num)
print("average working time of Process1_7: {:2.2f}".format(working_time_1[-1]))

working_time_2 = []
working_time_2.append(Proc2_1.working_time/Proc2_1.subprocess_num)
print("average working time of Process2_1: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_2.working_time/Proc2_2.subprocess_num)
print("average working time of Process2_2: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_3.working_time/Proc2_3.subprocess_num)
print("average working time of Process2_3: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_4.working_time/Proc2_4.subprocess_num)
print("average working time of Process2_4: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_5.working_time/Proc2_5.subprocess_num)
print("average working time of Process2_5: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_6.working_time/Proc2_6.subprocess_num)
print("average working time of Process2_6: {:2.2f}".format(working_time_2[-1]))
working_time_2.append(Proc2_7.working_time/Proc2_7.subprocess_num)
print("average working time of Process2_7: {:2.2f}".format(working_time_2[-1]))
...
axis.set_xlabel("proc1")
axis.set_ylabel("average working time")
plt.show()
...
axis.set_xlabel("proc2")
axis.set_ylabel("average working time")
plt.show()

fig, axis = plt.subplots()
axis.plot(Monitor1_7.times, Monitor1_7.sizes)
axis.set_title("WIP")
