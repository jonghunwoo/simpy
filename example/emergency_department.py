...
class Model:
    ...
    def build_audit_results(self):
        ...
        Global_vars.results['priority 1 patients waiting'] = Global_vars.audit_patients_waiting_p1
        Global_vars.results['priority 2 patients waiting'] = Global_vars.audit_patients_waiting_p2
        Global_vars.results['priority 3 patients waiting'] = Global_vars.audit_patients_waiting_p3
